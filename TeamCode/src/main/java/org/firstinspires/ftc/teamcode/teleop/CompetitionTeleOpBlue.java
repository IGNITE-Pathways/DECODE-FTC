...
/**
 * BLUE ALLIANCE Competition TeleOp
 * Turret tracks AprilTag ID 20 (Blue Alliance)
 *
...
public class CompetitionTeleOpBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        telemetry.addData("Target AprilTag", "20 (Blue)");
    ...
    private void initializeRobot() {
        telemetry.addLine("Initializing BLUE alliance robot...");
        telemetry.update();
    ...
    private void displayTelemetry() {
        ...
        if (turretAutoLock) {
            ...
            telemetry.addData("│ Tag", turret.isTagVisible() ? "✓ VISIBLE (ID 20)" : "NOT VISIBLE");
        } else {
        ...
        telemetry.addData("🏁 Alliance", ALLIANCE.name() + " (Tag 20)");
