package org.firstinspires.ftc.teamcode.competition.autonomous.red;
import org.firstinspires.ftc.teamcode.competition.autonomous.ShootingFunction;
...
import org.firstinspires.ftc.teamcode.competition.autonomous.pedro.Constants;
...
/**
 * Red Far Human Player Station - Preload only.
 * Starts at shoot pose (matches RedFar), shoots the three preload balls, then moves to HUMAN_POSITION.
 */
@Autonomous(name = "Red FAR Human", group = "Autonomous")
public class RedFarHuman extends OpMode {
    ...
    private static final Pose HUMAN_POSITION = new Pose(110, 10);  // Match RedFar LEAVE
    ...
    public void init() {
        ...
        telemetry.addLine("Red Far Human (Preload Only) Initialized");
    ...
    private void updateTelemetry() {
        telemetry.addLine("=== Red Far Human (Preload Only) ===");
